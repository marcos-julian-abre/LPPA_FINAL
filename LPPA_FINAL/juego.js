...
var triggerTerminar = false;

var puntosBlancas = 1;
var puntosNegras = 1;

var terminarPartida = 0;
...
function drawBoard() {
	...
	if (gGameInProgress && isTheGameOver()) {
		...
		puntosBlancas = 0;
		puntosNegras = 0;
		document.getElementById("puntuacionBlancas").innerHTML = puntosBlancas;
		document.getElementById("puntuacionNegras").innerHTML = puntosNegras;
		puntosBlancas = 1;
		puntosNegras = 1;
    } 
}
...
var nombreBlanca = "Blancas";
var nombreNegra = "Negras";


function setAction(nombre1, nombre2) {
	nombre1 = document.getElementById("nombreBlanca");
	nombre2 = document.getElementById("nombreNegra");
	nombreBlanca = nombre1.value;
	nombreNegra = nombre2.value;
	

	document.getElementById("moveNegras").innerHTML = nombreNegra;
	document.getElementById("moveBlancas").innerHTML = nombreBlanca;
	document.getElementById("esTurno").innerHTML = "Turno:" + nombreBlanca; 
...
function mostrarMovimiento(casilla1, casilla2, salto) {
	...
	if (salto && turnoBlancas){
		document.getElementById("puntuacionBlancas").innerHTML = puntosBlancas;
		puntosBlancas = puntosBlancas + 1;
	}
	else if (salto && turnoNegras){
		document.getElementById("puntuacionNegras").innerHTML = puntosNegras;
		puntosNegras = puntosNegras +1;
	}
	if (turnoBlancas){
		document.getElementById("esTurno").innerHTML = "Turno:" + nombreNegra;  
